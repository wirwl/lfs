...
namespace ZoomAndPan
{
    ...
    public partial class ZoomAndPanControl : ContentControl, IScrollInfo
    {
        ...
        /// </summary>
        public double constrainedContentViewportWidth = 0.0;

        /// <summary>
        /// The height of the viewport in content coordinates, clamped to the height of the content.
        /// </summary>
        public double constrainedContentViewportHeight = 0.0;
        ...
        /// </summary>
        public Size unScaledExtent = new Size(0, 0);
        ...
        public static readonly DependencyProperty MaxContentScaleProperty =
                DependencyProperty.Register("MaxContentScale", typeof(double), typeof(ZoomAndPanControl),
                                            new FrameworkPropertyMetadata(200.0, MinOrMaxContentScale_PropertyChanged));
        ...
        private static void ContentScale_PropertyChanged(DependencyObject o, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (c.enableContentOffsetUpdateFromScale)
            {
                try
                {
                    ...
                    //
                    double viewportOffsetX = (int)(c.ViewportZoomFocusX - (c.ViewportWidth / 2));
                    double viewportOffsetY = (int)(c.ViewportZoomFocusY - (c.ViewportHeight / 2));
                    double contentOffsetX = (int)(viewportOffsetX / c.ContentScale);
                    double contentOffsetY = (int)(viewportOffsetY / c.ContentScale);
                    c.ContentOffsetX = (int)((c.ContentZoomFocusX - (c.ContentViewportWidth / 2)) - contentOffsetX);
                    c.ContentOffsetY = (int)((c.ContentZoomFocusY - (c.ContentViewportHeight / 2)) - contentOffsetY);
                }
                finally
                {
        ...
        private static object ContentOffsetX_Coerce(DependencyObject d, object baseValue)
        {
         ...
         //   double maxOffsetX = Math.Max(0.0, (c.Content as FrameworkElement).Width - c.ContentViewportWidth);
        ...
        private static object ContentOffsetY_Coerce(DependencyObject d, object baseValue)
        {
            ...
            //double maxOffsetY = Math.Max(0.0, (c.Content as FrameworkElement).Height - c.ContentViewportHeight);
        ...
        /// </summary>
        public void UpdateContentViewportSize()
        {
            ContentViewportWidth = (int)(ViewportWidth / ContentScale);
            ContentViewportHeight =(int)( ViewportHeight / ContentScale);
            ...
            //bad:  200=Math.Min(220,200) 220=Math.Min(220,250) 220=Math.Min(220,250) 
            //good:  220 250
            UpdateTranslationX();
            UpdateTranslationY();
        }
            ...
            if (this.contentOffsetTransform != null)
            {
                ...
                if (scaledContentWidth < this.ViewportWidth)
                {
                  ...
                  //  if (this.ContentScale>1)
                    this.contentOffsetTransform.X = (int)((this.ContentViewportWidth - this.unScaledExtent.Width) / 2);
                 //   else this.contentOffsetTransform.X = ((this.ContentViewportWidth - this.unScaledExtent.Width) / 2);
                }
                else
                {
                //    if (this.ContentScale > 1)
                    this.contentOffsetTransform.X = (int)(-this.ContentOffsetX);
                //    else this.contentOffsetTransform.X = (-this.ContentOffsetX);
                }
            }
        }
        ...
        private void UpdateTranslationY()
        {
            if (this.contentOffsetTransform != null)
            {
                ...
                if (scaledContentHeight < this.ViewportHeight)
                {
                    ...
                    //
                //    if (this.ContentScale > 1)
                    this.contentOffsetTransform.Y =(int)((this.ContentViewportHeight - this.unScaledExtent.Height) / 2);
                //    else this.contentOffsetTransform.Y = ((this.ContentViewportHeight - this.unScaledExtent.Height) / 2);
                }
                else
                {
               //     if (this.ContentScale > 1)
                    this.contentOffsetTransform.Y = (int)-this.ContentOffsetY;
              //      else this.contentOffsetTransform.Y = -this.ContentOffsetY;
                }
            }
        }
        ...
        {
            ContentZoomFocusX =(int)( ContentOffsetX + (constrainedContentViewportWidth / 2));
        }
        ...
        {
            ContentZoomFocusY =(int)( ContentOffsetY + (constrainedContentViewportHeight / 2));
        }
